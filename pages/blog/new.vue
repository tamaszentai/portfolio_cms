    ...
    <div>
        <NuxtLayout name="admin">
            <div class="flex justify-between items-center">
                <h1 class="text-3xl font-bold">Új blogbejegyzés</h1>
            ...
            <form @submit.prevent="addPost" class="relative w-2/3 mt-6">
...
const addPost = async () => {
    ...
    try {
      await blogStore.createBlogPost(payload);
      title.value = '';
      description.value = '';
      dashboardStore.dashboardReset();
      await router.push('/blog');
      notify({message: 'Sikeresen hozzáadtad a bejegyzést!', type: 'success'})
    } catch (e) {
      console.log(e);
      notify({message: 'Hiba történt a bejegyzés hozzáadása közben!', type: 'error'})
    }
}
